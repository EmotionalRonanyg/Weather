...
import info.emotionalronan.weather.gson.ForeCast;
import info.emotionalronan.weather.gson.Weather;
import info.emotionalronan.weather.service.AutoUpdateService;
...
*/
    ...
    private void loadBingPic() {
        ...
        String requrstBingPic = "http://guolin.tech/api/bing_pic";
        HttpUtil.sendOkHttpRequest(requrstBingPic, new Callback() {
            @Override
    ...
    public void requestWeather(final String weatherId) {
        ...
        LogUtil.d("------------WeatherActivity ","weatherId"+weatherId);
